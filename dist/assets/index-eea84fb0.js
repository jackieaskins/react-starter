...
function jc(e, n, t, r, l, u, o, i, s) {
  (kt = !1), (Lr = null), Ic.apply(Fc, arguments);
}
function Uc(e, n, t, r, l, u, o, i, s) {
  if ((jc.apply(this, arguments), kt)) {
    if (kt) {
      var c = Lr;
      (kt = !1), (Lr = null);
...
for (var Ll = 0; Ll < oi.length; Ll++) {
  var Tl = oi[Ll],
    $f = Tl.toLowerCase(),
    Af = Tl[0].toUpperCase() + Tl.slice(1);
  dn($f, "on" + Af);
}
...
function wa(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), ol(4, 4, ga.bind(null, n, e), t)
  );
}
function wo() {}
function Sa(e, n) {
...
function zi(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    _r(e, n), la(n, t, r), ku(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function fd(e, n) {
  ...
  for (du = { focusedElem: e, selectionRange: t }, Mr = !1, k = n; k !== null; )
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[$t], delete n[vu], delete n[Yf], delete n[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Qo(t), n === 1))
      e.tag === 0 ? Gf(ji.bind(null, e)) : Js(ji.bind(null, e)),
        Qf(function () {
          !(R & 6) && mn();
        }),
        (t = null);
...
Ga = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if (!(e.lanes & t) && !(n.flags & 128)) return (ae = !1), id(e, n, t);
      ae = !!(e.flags & 131072);
    }
...
hs = _o;
ys = zn;
var Nd = { usingClientEntryPoint: !1, Events: [Gt, jn, rl, ms, vs, _o] },
  vt = {
...
function Td() {
  return Hl.jsx("h1", { children: "React Starter" });
}
const tc = document.getElementById("root");
if (!tc) throw new Error("No root element found");
nc(tc).render(Hl.jsx(Au.StrictMode, { children: Hl.jsx(Td, {}) }));
